...
locations = [lobby, zero_four, book_room, one_one_corridor, one_two_corridor, one_three, one_four, one_five, one_six, one_seven, lectern_room, two_four, two_five, two_six]
multiple_edges = [book_room, one_three, one_six]
no_edges = [lobby, one_seven, lectern_room, two_five, two_six]
no_examine = [lobby, two_four, two_five, two_six]
no_interact = [one_four, one_six, one_five, two_four, two_five]
